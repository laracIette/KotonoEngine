...
void KtContext::Cleanup() const
{
	...
	{
		vmaDestroyBuffer(_allocator, _uniformBuffers[i], _uniformBuffersAllocation[i]);
	}
...
VkDescriptorSetLayout& KtContext::GetDescriptorSetLayout()
{
	return _descriptorSetLayout;
}

VkPipelineLayout& KtContext::GetPipelineLayout()
{
	return _pipelineLayout;
}

VkExtent2D KtContext::GetSwapChainExtent() const
{
	return _swapChainExtent;
}

VkRenderPass KtContext::GetRenderPass() const
{
	return _renderPass;
}

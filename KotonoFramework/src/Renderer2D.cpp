...
void KtRenderer2D::AddToRenderQueue(KtShader2D* shader, const KtObjectData2D& objectData)
{
	_renderQueue2DData.Shaders[shader].ObjectDatas.push_back(objectData);
}
